...
global.hpModifications = {
	...
	"minecraft:villager": [100, 15, 10],
	"minecraft:vindicator": [120, 13, 0],
	...
	"born_in_chaos_v1:decrepit_skeleton": [45, 10, 0],
	"born_in_chaos_v1:skeleton_demoman": [95, 15, 2],
	"born_in_chaos_v1:decaying_zombie": [75, 12, 0],
	"born_in_chaos_v1:decaying_zombie_not_despawn": [75, 12, 0],
	"born_in_chaos_v1:baby_skeleton": [40, 8, 1],
	"born_in_chaos_v1:baby_skeleton_minion": [40, 8, 1],
	"born_in_chaos_v1:controlled_baby_skeleton": [80, 15, 1],
	"born_in_chaos_v1:barrel_zombie": [90, 11, 8],
	"born_in_chaos_v1:phantom_creeper": [60, 15, 0],
	"born_in_chaos_v1:phantom_creeper_copy": [60, 15, 0],
	"born_in_chaos_v1:door_knight": [80, 10, 7],
	"born_in_chaos_v1:door_knight_not_despawn": [80, 10, 7],
	"born_in_chaos_v1:restless_spirit": [50, 11, 0],
	...
	"born_in_chaos_v1:firelight": [40, 6, 0],
	...
	"born_in_chaos_v1:bonescaller_not_despawn": [125, 15, 1],
	"born_in_chaos_v1:bone_imp": [60, 15, 3],
	"born_in_chaos_v1:bone_imp_minion": [60, 15, 3],
	"born_in_chaos_v1:supreme_bonescaller": [300, 25, 5],
	"born_in_chaos_v1:supreme_bonescaller_stage_10": [300, 25, 5],
	"born_in_chaos_v1:supreme_bonescaller_not_despawn": [300, 25, 5],
	"born_in_chaos_v1:dark_vortex": [90, 20, 0],
	"born_in_chaos_v1:dread_hound": [50, 17, 0],
	"born_in_chaos_v1:dread_hound_not_despawn": [50, 17, 0],
	"born_in_chaos_v1:fallen_chaos_knight": [50, 19, 12],
	...
	"born_in_chaos_v1:zombie_clown_not_despawn": [110, 15, 3],
	...
	"born_in_chaos_v1:zombie_lumberjack": [80, 20, 4],
	"born_in_chaos_v1:siamese_skeletons": [60, 12, 0],
	"born_in_chaos_v1:siamese_skeletonsleft": [30, 6, 0],
	"born_in_chaos_v1:siamese_skeletonsright": [30, 6, 0],
	...
	"lost_aether_content:aerwhale_king": [2500, 50, 0],
	...
	"witherstormmod:sickened_zombie": [60, 15, 4],
	"witherstormmod:sickened_skeleton": [50, 10, 2],
	"witherstormmod:sickened_spider": [40, 15, 2],
	"witherstormmod:sickened_creeper": [40, 10, 0],
	"witherstormmod:command_block": [5000, 15, 30],
	"witherstormmod:withered_symbiont": [500, 60, 20],
	"witherstormmod:wither_storm_head": [300, 10, 10],
	"witherstormmod:tentacle": [400, 10, 6],
	"witherstormmod:sickened_villager": [90, 15, 8],
	"witherstormmod:sickened_phantom": [40, 11, 0],
	"witherstormmod:sickened_chicken": [30, 9, 0],
	"witherstormmod:sickened_parrot": [30, 9, 0],
	"witherstormmod:sickened_wolf": [30, 17, 0],
	"witherstormmod:sickened_cat": [30, 12, 0],
	"witherstormmod:sickened_cow": [40, 10, 0],
	"witherstormmod:sickened_pig": [40, 9, 0],
	"witherstormmod:sickened_mushroom_cow": [40, 10, 0],
	"witherstormmod:sickened_bee": [30, 10, 0],
	"witherstormmod:sickened_pillager": [110, 22, 0],
	"witherstormmod:sickened_vindicator": [110, 22, 0],
	"witherstormmod:sickened_iron_golem": [600, 50, 0],
	...
	"upgrade_aquatic:nautilus": [15, 15, 10],
	"upgrade_aquatic:pike": [15, 15, 0],
	"upgrade_aquatic:perch": [15, 15, 0],
	"upgrade_aquatic:lionfish": [15, 15, 0],
	"upgrade_aquatic:thrasher": [15, 20, 8],
	...
	"rediscovered:steve": [150, 10, 5],
	"rediscovered:rana": [150, 10, 5],
	"rediscovered:black_steve": [150, 10, 5],
	"rediscovered:beast_boy": [250, 10, 0],
	"rediscovered:red_dragon": [3300, 25, 0],
	"rediscovered:red_dragon_offspring": [1000, 15, 0],
...
EntityJSEvents.attributes(event => {
	...
	event.modify('player', attributes => {
		...
		attributes.add('stardew_fishing:bar_size', 44)
	})
