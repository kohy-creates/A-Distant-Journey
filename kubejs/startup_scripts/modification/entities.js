...
global.hpModifications = {
	...
	"minecraft:elder_guardian": [700, 40, 0],
	...
	"minecraft:giant": [500, 80, 0],
	"minecraft:glow_squid": [30, 15, 0],
	"minecraft:goat": [30, 10, 0],
	"minecraft:guardian": [60, 20, 3],
	...
	"minecraft:piglin": [70, 10, 0],
	"minecraft:piglin_brute": [160, 15, 0],
	"minecraft:pillager": [90, 25, 0],
	...
	"majruszsdifficulty:cerberus": [800, 25, 10],
	"majruszsdifficulty:creeperling": [30, 10, 0],
	"majruszsdifficulty:giant": [500, 60, 0],
	...
	"born_in_chaos_v1:decrepit_skeleton": [45, 15, 0],
	"born_in_chaos_v1:skeleton_demoman": [125, 15, 2],
	"born_in_chaos_v1:decaying_zombie": [125, 20, 0],
	"born_in_chaos_v1:baby_skeleton": [50, 10, 1],
	"born_in_chaos_v1:baby_skeleton_minion": [50, 10, 1],
	"born_in_chaos_v1:controlled_baby_skeleton": [100, 20, 1],
	"born_in_chaos_v1:barrel_zombie": [150, 15, 6],
	"born_in_chaos_v1:phantom_creeper": [100, 15, 0],
	"born_in_chaos_v1:phantom_creeper_copy": [100, 15, 4],
	"born_in_chaos_v1:door_knight": [150, 30, 7],
	"born_in_chaos_v1:restless_spirit": [120, 10, 0],
	"born_in_chaos_v1:skeleton_thrasher": [250, 40, 0],
	"born_in_chaos_v1:pumpkin_spirit": [330, 65, 2],
	"born_in_chaos_v1:seared_spirit": [250, 50, 3],
	"born_in_chaos_v1:firelight": [75, 10, 0],
	"born_in_chaos_v1:diamond_termite": [70, 10, 8],
	"born_in_chaos_v1:bonescaller": [125, 15, 1],
	"born_in_chaos_v1:bone_imp": [100, 15, 3],
	"born_in_chaos_v1:bone_imp_minion": [100, 15, 3],
	"born_in_chaos_v1:supreme_bonescaller": [325, 25, 5],
	"born_in_chaos_v1:supreme_bonescaller_stage_10": [60, 25, 5],
	"born_in_chaos_v1:dark_vortex": [175, 20, 0],
	"born_in_chaos_v1:dread_hound": [85, 25, 0],
	"born_in_chaos_v1:fallen_chaos_knight": [600, 25, 2],
	"born_in_chaos_v1:scarlet_persecutor": [175, 25, 0],
	"born_in_chaos_v1:spirit_guide": [160, 15, 3],
	"born_in_chaos_v1:spirit_guide_assistant": [75, 10, 3],
	"born_in_chaos_v1:zombie_clown": [175, 15, 4],
	...
	"born_in_chaos_v1:decaying_zombie_not_despawn": [150, 20, 0],
	"born_in_chaos_v1:door_knight_not_despawn": [150, 30, 7],
	"born_in_chaos_v1:bonescaller_not_despawn": [125, 15, 0],
	"born_in_chaos_v1:supreme_bonescaller_not_despawn": [325, 25, 5],
	"born_in_chaos_v1:skeleton_thrasher_not_despawn": [250, 40, 8],
	"born_in_chaos_v1:dread_hound_not_despawn": [85, 15, 0],
	"born_in_chaos_v1:firelight_not_despawn": [75, 10, 0],
	"born_in_chaos_v1:zombie_clown_not_despawn": [300, 25, 4],
	"born_in_chaos_v1:seared_spirit_not_despawn": [250, 50, 3],
	"born_in_chaos_v1:dire_hound_leader": [500, 50, 0],
	"born_in_chaos_v1:maggot": [5, 1, 0],
	"born_in_chaos_v1:corpse_fly": [50, 5, 0],
	"born_in_chaos_v1:bloody_gadfly": [100, 13, 0],
	"born_in_chaos_v1:corpse_fish": [60, 12, 0],
	"born_in_chaos_v1:zombie_fisherman": [125, 20, 4],
	"born_in_chaos_v1:swarmer": [200, 14, 4],
	"born_in_chaos_v1:thornshell_crab": [125, 20, 4],
	"born_in_chaos_v1:glutton_fish": [450, 40, 3],
	"born_in_chaos_v1:zombie_bruiser": [300, 30, 2],
	...
	"born_in_chaos_v1:zombie_lumberjack": [125, 45, 4],
	"born_in_chaos_v1:siamese_skeletons": [100, 15, 2],
	"born_in_chaos_v1:siamese_skeletonsleft": [50, 10, 1],
	"born_in_chaos_v1:siamese_skeletonsright": [50, 10, 1],
	"born_in_chaos_v1:missioner": [750, 45, 0],
	"born_in_chaos_v1:phantom_bomb_entity": [75, 5, 0],
	"born_in_chaos_v1:controlled_spiritual_assistant": [150, 30, 3],
	"born_in_chaos_v1:spiritof_chaos": [60, 15, 0],
	"born_in_chaos_v1:lifestealer": [400, 23, 10],
	"born_in_chaos_v1:lifestealer_true_form": [400, 23, 7],
	"born_in_chaos_v1:baby_spider": [50, 10, 0],
	"born_in_chaos_v1:mother_spider": [450, 30, 0],
	"born_in_chaos_v1:baby_spider_controlled": [50, 10, 0],
	"born_in_chaos_v1:nightmare_stalker": [120, 25, 6],
	"born_in_chaos_v1:pumpkin_dunce": [100, 15, 0],
	"born_in_chaos_v1:mrs_pumpkin": [150, 15, 1],
	"born_in_chaos_v1:pumpkin_bruiser": [450, 45, 6],
	"born_in_chaos_v1:krampus": [700, 35, 8],
	"born_in_chaos_v1:krampus_henchman": [150, 177, 5],
	"born_in_chaos_v1:missionary_raider": [750, 45, 0],
	...
	"witherstormmod:sickened_zombie": [160, 15, 4],
	"witherstormmod:sickened_skeleton": [130, 10, 2],
	"witherstormmod:sickened_spider": [110, 15, 2],
	"witherstormmod:sickened_creeper": [90, 10, 0],
	"witherstormmod:command_block": [500, 15, 30],
	"witherstormmod:withered_symbiont": [500, 80, 20],
	"witherstormmod:wither_storm_head": [300, 10, 10],
	"witherstormmod:tentacle": [500, 10, 6],
	"witherstormmod:sickened_villager": [120, 15, 8],
	...
	"witherstormmod:sickened_iron_golem": [700, 50, 0],
	...
	"alexsmobs:toucan": [30, 10, 0],
	"alexsmobs:maned_wolf": [80, 10, 0],
	"alexsmobs:anaconda": [200, 10, 0],
	...
	"alexsmobs:bunfungus": [400, 40, 0],
	"alexsmobs:bison": [200, 40, 0],
	"alexsmobs:giant_squid": [190, 40, 0],
	"alexsmobs:sea_bear": [1000, 40, 0],
	"alexsmobs:devils_hole_pupfish": [10, 10, 0],
	"alexsmobs:catfish": [50, 10, 0],
	"alexsmobs:flying_fish": [30, 10, 0],
	"alexsmobs:skelewag": [100, 15, 0],
	"alexsmobs:rain_frog": [30, 10, 0],
	"alexsmobs:potoo": [40, 5, 0],
	"alexsmobs:mudskipper": [60, 10, 0],
	"alexsmobs:rhinoceros": [300, 40, 12],
...
EntityJSEvents.attributes(event => {
	...
	const WitherStormFlyingSpeed = 0.004;
	event.modify('witherstormmod:wither_storm', attributes => {
		attributes.add('witherstormmod:slow_flying_speed', WitherStormFlyingSpeed);
		attributes.add('witherstormmod:target_stationary_flying_speed', WitherStormFlyingSpeed);
	})
})
