...
global.stageRestrictions = {
	...
	'chapter_3': {
		...
		light: [
			...
			/twilight(forest|delight):fiery/,
			/twilight(forest|delight):.*carminite/,
			/twilight(forest|delight):towerwood/,
			/twilight(forest|delight):encased_/,
	...
	'chapter_4': {
		...
		light: [
			...
			/twilight(forest|delight):.*aurora/,
			/twilight(forest|delight):.*glacier/,
			'twilightforest:uberous_soil',
			'twilightforest:lamp_of_cinders',
			'twilightforest:ghast_trap',
			/twilight(forest|delight):giant/,
			/twilight(forest|delight):.*castle/,
			/twilight(forest|delight):deadrock/,
			'twilightforest:uncrafting_table',
			/twilight(forest|delight):.*arctic/,
			/twilight(forest|delight):.*yeti/,
		],
		exceptions: [
