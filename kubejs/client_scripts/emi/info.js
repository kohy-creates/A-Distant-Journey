JEIEvents.information(event => {
	...
	addInfo(['#beds', '#upgrade_aquatic:bedrolls'], [
	...
	addInfo('netherexp:warped_wart', [
		'Can be planted on Soul Sand. Unlike it\'s crimson counterpart, it grows from its underside rather than the top.',
		'It\'s critically endangered and cannot be found growing in the wild, but it can still be found in Sanctums (HINT: You can use a Sanctum Compass to locate one).'
	]);

	addInfo('nether_wart', [
		'Can be planted on top of Soul Sand.',
		'Can rarely be found growing naturally anywhere in The Nether, or more often, cultivated in Nether Fortresses.'
	]);

	addInfo(['compass', 'recovery_compass', 'clock', 'additionaladditions:depth_meter', 'mythicmetals:platinum_watch', 'naturescompass:naturescompass'], [
	...
	*/
	...
	/* 
		Etched
	*/
	addInfo(['#music_discs', 'etched:blank_music_disc'], [
	...
	addInfo(['etched:album_cover', 'etched:album_jukebox', 'etched:boombox', '#music_discs'], [
	...
	/*
		Progression
	*/
	addInfo(['ancient_debris', 'netherite_ingot', 'netherite_scrap', 'netherite_block'], [
		'Netherite generates in The Nether only after collecting the Eye of Angels.'
	]);
	addInfo(['ancient_debris',], [
	...
	/*
		Enchanting
	*/
	addInfo(['enchanted_book', 'sortilege:limitite'], [
	...
	*/
	...
	], "Will crack after 8-10 days, or 4-5 if on top of Fern Thatch.");
