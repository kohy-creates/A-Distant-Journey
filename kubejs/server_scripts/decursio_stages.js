...
const DecursioStages = {
	...
	GAMERULES: {
		'chapter_0': {
			...
			'artifacts.bunnyHoppers.jumpBoostLevel': '1',
			'artifacts.chorusTotem.cooldown': '180',
			'artifacts.chorusTotem.doConsumeOnUse': false,
			'artifacts.chorusTotem.healthRestored': '50',
			'artifacts.diggingClaws.toolTier': '3',
			'artifacts.diggingClaws.digSpeedBonus': '25',
			'artifacts.villagerHat.reputationBonus': '30',
			'artifacts.universalAttractor.enabled': false,
			'artifacts.vampiricGlove.maxHealingPerHit': '3',
			'artifacts.vampiricGlove.absorptionRatio': '2',
			'artifacts.thornPendant.cooldown': '20',
			'artifacts.thornPendant.minDamage': '10',
			'artifacts.thornPendant.maxDamage': '20',
			'artifacts.thornPendant.strikeChance': '100',
			'artifacts.snowshoes.slipperinessReduction': '25',
			'artifacts.snorkel.waterBreathingDuration': '8',
			'artifacts.steadfastSpikes.enabled': false,
			'artifacts.superstitiousHat.lootingLevelBonus': '0',
			'artifacts.luckyScarf.fortuneBonus': '0',
			'artifacts.scarfOfInvisibility.enabled': false,
			'artifacts.goldenHook.experienceBonus': '25',
			...
			'skeletonThrasherSpawn': false,
			'zombieBruiserSpawn': false,
			'corpseFlySpawn': true,
		...
		'chapter_3': {
			...
			'skeletonThrasherSpawn': true,
			'zombieBruiserSpawn': true,
